...
class MyController(http.Controller):
    ...
    def exam_content(self, exam_slug):
        exam = http.request.env['at.evaluation'].sudo().search([('slug', '=', exam_slug)])[0]
        return http.request.render('custom_evaluation.at_evaluation_content', {'exam': exam})
    ...
    def take_exam_token(self, exam_slug, token):
        ...
        if exam_result.state == "complete":
            ...
            return http.request.render('custom_evaluation.at_evaluation_question_page',
    ...
    def exam_result(self, **kwargs):
        ...
        return request.render('custom_evaluation.at_evaluation_results',{'exam_result': exam_result, 'question_count': question_count,
